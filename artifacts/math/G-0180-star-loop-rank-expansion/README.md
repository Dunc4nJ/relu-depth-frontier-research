...
Status: **completed negative rank gate; exact kernel-lifting branch active**.
...
The first gate appended 480 domain-hash-selected directions to the original
...
Both gates returned rank 5,291 at both fixed primes: all 1,024 new directions
added zero pivots.  This blocks the preregistered 5,769-row theorem and shifts
the campaign to exact lifting of the resulting 478-dimensional restriction
kernel into the old span \(O\).  See [RESULT.md](RESULT.md) for the evidence and
claim boundary.
...
The theorem, custody hashes, exact commands, and outcome rules were frozen in
