...
Status: **awaiting the preregistered 5,771 by 5,771 determinant**.  No rank or
determinant of the decisive square had been observed when this bundle was
frozen.
...
If the frozen square is nonsingular, the remaining `STAR` columns add a direct
...
The exact theorem, hashes, commands, and outcome branches are frozen in
[PREREGISTRATION.md](PREREGISTRATION.md).  The decisive output is intentionally
