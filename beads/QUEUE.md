...
- [ ] G-0011 Exact-price all 18,582 same-component Y-spoke orbits, run capped target-aware quotient CEGIS on the complete new family, and exact-lift the resulting member or separator. (claimed-by: research-lead/crimsonbirch)
