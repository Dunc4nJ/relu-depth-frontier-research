...
- [ ] G-0011 Independently audit and preregister the complete 26,689-column Schur/RREF run, execute it, preserve the full nullspace transform, and exact-lift or globally separate the resulting branch. (claimed-by: research-lead/crimsonbirch)
- [ ] G-0012 Derive and solve the exact off-facet wall-cancellation equations for globally glued full-dimensional blocks, retaining support heights and rejecting RANGE11. (claimed-by: research-lead/beigeturtle)
